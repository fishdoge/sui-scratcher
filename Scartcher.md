...
### Published Init Transaction Digest EmBYDE5An1XMXVbqxCo4WaCLAfpbCC7DdUGtLHaK7BaH
```
...
### add_whitelist_coin Transaction Digest CcxN6nEU8o7SJaJW3oDmD1Hgpwrz81sUcYYp7YNgmcB8
```
...
### create_shop Transaction Digest 9Xo8R8XFf6fdDHVsSMU7P7z51S2xgTpgygt2Tg31z1kq
```
sui client call \
--package 0xd8cc41b8b844a4dc88015918d1bfd3b5ec202c7f86052580d3cd509bfab9292a \
--module suirandom \
...
```
### deposit_reward_pool Transaction Digest HoiBB4eGTeziuwMRTnZ2Ut4nejATPdLBQsjs8mvCeTGk
```
...
### start_new_collect_book Transaction Digest 8y5BJN6EQpWk44Qvth7mADu7e6hyoEN92AfTybqH9GnP
```
sui client call \
--package 0xd8cc41b8b844a4dc88015918d1bfd3b5ec202c7f86052580d3cd509bfab9292a \
--module suirandom \
...
```
### packup Transaction Digest
```
Coin<usdt,least 5>: 0x7b0d8090a8a39c885c3216f61c05b762fbcc97ce63f81ee913bcca8a80fd3238 
```
```
sui client call \
--package 0xd8cc41b8b844a4dc88015918d1bfd3b5ec202c7f86052580d3cd509bfab9292a \
...
### ~~withdraw_reward_pool Transaction Digest CKNqoM2gQF1qL6YNfTWZ9RmiEP5vNnxoKBKvk7qRcsD3~~
```
sui client call \
--package 0xd8cc41b8b844a4dc88015918d1bfd3b5ec202c7f86052580d3cd509bfab9292a \
--module suirandom \
