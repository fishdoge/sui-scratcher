...
export default function Leaderboard({ players, className }: LeaderboardProps) {
  ...
  return (
    <motion.div
      className={cn("bg-white/90 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden", className)}
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <span className="font-medium text-purple-600">{player.plays} plays</span>
                  <span>•</span>
